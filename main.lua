		...
		if pcall(function() readfile("IY_FE.iy") end) then
			if readfile("IY_FE.iy") ~= nil then
				local success, response = pcall(function()
					...
					if json.espTransparency ~= nil then espTransparency = json.espTransparency else espTransparency = 0.1 end
...
CMDs[#CMDs + 1] = {NAME = 'loopspeed / ls [num]', DESC = 'Loops your walkspeed'}
CMDs[#CMDs + 1] = {NAME = 'unloopspeed / .', DESC = 'Turns off loopspeed'}
...
function ESP(plr)
    task.spawn(function()
        ...
        if plr.Character and plr.Name ~= Players.LocalPlayer.Name and not COREGUI:FindFirstChild(plr.Name..'_ESP') then
            ...
            -- CÃ³digo removido que cria adornos para as partes do corpo
            
            if plr.Character and plr.Character:FindFirstChild('Head') then
                -- CÃ³digo para criar um BillboardGui com o nome do jogador na cabeÃ§a
...
addcmd('loopspeed',{'ls'},function(args, speaker)
	local speed = args[1] or 16
	if args[2] then
		speed = args[2] or 16
	end
...
addcmd('unloopspeed',{'.'},function(args, speaker)
